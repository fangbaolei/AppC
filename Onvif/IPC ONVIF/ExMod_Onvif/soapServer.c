...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.0 2012-03-12 06:20:53 GMT")
...
{	struct __tds__GetCapabilities soap_tmp___tds__GetCapabilities={0};
struct _tds__GetCapabilitiesResponse tds__GetCapabilitiesResponse={0};
